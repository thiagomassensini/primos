# Ledger de afirmacoes — checkpoint 0.12.0 Genuine-first
...
| GEN-CP-CHART-FIN | nos centros `p,2p,...,Mp`, os blocos ladrilham exatamente `1,...,pM+halfRange(p)` e a carta finita e esse prefixo literal menos `p` vezes a soma dos centros | KERNEL_CHECKED | GEN-CP-BLOCK, GEN-CP-002 | fatorar a correcao vertical para o termo complexo de Dirichlet |
...
| CHP-001 | carta e fator vezes Genuine | PAPER_ARGUMENT | GEN-CP-CHART-FIN, fatoracao dos centros, convergencia e analise | fatorar a soma vertical antes de tomar limites |
...
commit `bad4f56825e0d42d0fc628c3a54a46d8503865bf`, run `29649780593`.
