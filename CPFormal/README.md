...
- o cancelamento do endpoint interno pelo traco bracketado permanece uma
...
verificacao no commit `1fc3d26f66eff2a4772d6ad5f073b923f6c1156f`, workflow
run `29705176557`. A certificacao cobre os imports de `CPFormal.lean`;
...
37. `CPFormal/Analytic/CpGreenBridge.lean`
